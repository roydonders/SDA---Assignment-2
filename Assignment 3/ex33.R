...
plot(dCV, xlim=c(3,6), ylim=c(0.0,1.0), main="KDE (bandwidth = h_CV) compared with true density sample33")
lines(xgamma+2, ygamma, col="red")
plot(dOPT, xlim=c(3,6), ylim=c(0.0,1.0), main="KDE (bandwidth = h_OPT) compared with true density sample33", col = "seagreen4")
lines(xgamma+2, ygamma, col="red")