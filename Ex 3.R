...
plot(density(c(sample31),bw= multi_bw), col="red",main="Bimodal, standard R bandwidth")
plot(density(c(sample31),bw= multi_bw/1.2),col="red",main="Bimodal, bandwidth = h_opt/1.2")
plot(density(c(sample31),bw= multi_bw/1.5),col="red",main="Bimodal, bandwidth = h_opt/1.5")
plot(density(c(sample31),bw= multi_bw/1.6),col="red",main="Bimodal, bandwidth = h_opt/1.6")
plot(density(c(sample31),bw= multi_bw/2),col="red",main="Bimodal, bandwidth = h_opt/2")
plot(density(c(sample31),bw= multi_bw/4),col="red",main="Bimodal, bandwidth = h_opt/4")
